...
//remonte les infos de la carte demand�e
...
else
{
	...
	for ($i=0; $i<count($persos); $i++)
	{
		...
		//recherche le backup
		if (sql_num_rows($res_perso) > 0) //perso trouv�
		{
